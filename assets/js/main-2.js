...
function getTotalData() {
	...
	if($collection.total_qty >= 100) {
		...
		$(".freewb").each(function() {
			// Place to collection
			if(typeof $collection.free["wristbands"] == "undefined" || $collection.free["wristbands"] == null) { $collection.free["wristbands"] = { qty:0, data:[] }; }
