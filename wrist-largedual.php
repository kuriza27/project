				  ...
				  <div class="content">
					<div id="dual-fig-reg" class="tab-pane js-color" data-value="0.01" data-color="Dual">
					  ...
					  <div id="main-color-content">
						...
						<div class="col-xs-4 box-color">
							<img src="assets/images/dual/Large/BlackGreen.png"/>
						...
						<div class="col-xs-4 box-color">
							<img src="assets/images/dual/Large/GoldBlack.png"/>
							...
							<div class="col-xs-4 col-sm-4"><label>Youth Qty </label><input ref="836F3D,000000" type="number" name="youth-qty" class="qtyin-youth-qty" placeholder="0"/></div>
							<div class="clearfix"></div>
							<!---------Start text color option------------>
								<div class="color-text" style="display:none">
									<div class="col-sm-1">
							...
							<span class="view-more col-xs-12">View More Sizes</span>
							<div class="show-content">
								<div class="col-xs-4 col-sm-6"><label>Extra Small Qty</label><input ref="836F3D,000000" type="number" name="xt-small-qty" class="xt-small-qty" placeholder="0"/></div>
								<div class="col-xs-4 col-sm-6"><label>Extra Large Qty </label><input ref="836F3D,000000" type="number" name="xt-large-qty" class="xt-large-qty" placeholder="0"/></div>
							</div>
						</div>
						<div class="col-xs-4 box-color">
							<img src="assets/images/dual/Large/GreyBlack.png"/>
							...
							<div class="col-xs-4 col-sm-4"><label>Youth Qty </label><input ref="8D8F8C,000000" type="number" name="youth-qty" class="qtyin-youth-qty" placeholder="0"/></div>
							<div class="clearfix"></div>
							<!---------Start text color option------------>
								<div class="color-text" style="display:none">
									<div class="col-sm-1">
							...
							<span class="view-more col-xs-12">View More Sizes</span>
							<div class="show-content">
								<div class="col-xs-4 col-sm-6"><label>Extra Small Qty</label><input ref="8D8F8C,000000" type="number" name="xt-small-qty" class="xt-small-qty" placeholder="0"/></div>
								<div class="col-xs-4 col-sm-6"><label>Extra Large Qty </label><input ref="8D8F8C,000000" type="number" name="xt-large-qty" class="xt-large-qty" placeholder="0"/></div>
							</div>
						</div>
						<div class="col-xs-4 box-color">
							<img src="assets/images/dual/Large/OrangeBlack.png"/>
							...
							<div class="col-xs-4 col-sm-4"><label>Youth Qty </label><input ref="EF6B01,000000" type="number" name="youth-qty" class="qtyin-youth-qty" placeholder="0"/></div>
							<div class="clearfix"></div>
							<!---------Start text color option------------>
								<div class="color-text" style="display:none">
									<div class="col-sm-1">
							...
							<span class="view-more col-xs-12">View More Sizes</span>
							<div class="show-content">
								<div class="col-xs-4 col-sm-6"><label>Extra Small Qty</label><input ref="EF6B01,000000" type="number" name="xt-small-qty" class="xt-small-qty" placeholder="0"/></div>
								<div class="col-xs-4 col-sm-6"><label>Extra Large Qty </label><input ref="EF6B01,000000" type="number" name="xt-large-qty" class="xt-large-qty" placeholder="0"/></div>
							</div>
						</div>
						<div class="col-xs-4 box-color">
							<img src="assets/images/dual/Large/BlackYellow.png"/>
						...
						<div class="col-xs-4 box-color">
							<img src="assets/images/dual/Large/BlueGrey.png"/>
						...
						<div class="col-xs-4 box-color">
							<img src="assets/images/dual/Large/RedGreen.png"/>
						...
						<div class="col-xs-4 box-color">
							<img src="assets/images/dual/Large/GreyRed.png"/>
							...
							<div class="col-xs-4 col-sm-4"><label>Youth Qty </label><input ref="A0A29F,EA0D2C" type="number" name="youth-qty" class="qtyin-youth-qty" placeholder="0"/></div>
							<div class="clearfix"></div>
							<!---------Start text color option------------>
								<div class="color-text" style="display:none">
									<div class="col-sm-1">
							...
							<span class="view-more col-xs-12">View More Sizes</span>
							<div class="show-content">
								<div class="col-xs-4 col-sm-6"><label>Extra Small Qty</label><input ref="A0A29F,EA0D2C" type="number" name="xt-small-qty" class="xt-small-qty" placeholder="0"/></div>
								<div class="col-xs-4 col-sm-6"><label>Extra Large Qty </label><input ref="A0A29F,EA0D2C" type="number" name="xt-large-qty" class="xt-large-qty" placeholder="0"/></div>
							</div>
						</div>
						<div class="col-xs-4 box-color">
							<img src="assets/images/dual/Large/RedYellow.png"/>
						...
						<div class="col-xs-4 box-color">
							<img src="assets/images/dual/Large/WhiteBlue.png"/>
						...
						<div class="col-xs-4 box-color">
							<img src="assets/images/dual/Large/WhiteGreen.png"/>
						...
						<div class="col-xs-4 box-color">
							<img src="assets/images/dual/Large/LightBlueWhite.png"/>
							...
							<div class="col-xs-4 col-sm-4"><label>Youth Qty </label><input ref="9ABFE5,FEFEFE" type="number" name="youth-qty" class="qtyin-youth-qty" placeholder="0"/></div>
							<div class="clearfix"></div>
							<!---------Start text color option------------>
								<div class="color-text" style="display:none">
									<div class="col-sm-1">
						...
						<div class="col-xs-4 box-color">
							<img src="assets/images/dual/Large/WhiteOrange.png"/>
						...
						<div class="col-xs-4 box-color">
							<img src="assets/images/dual/Large/WhitePink.png"/>
						...
						<div class="col-xs-4 box-color">
							<img src="assets/images/dual/Large/WhiteRed.png"/>
						...
						<div class="col-xs-4 box-color">
							<img src="assets/images/dual/Large/YellowBlue.png"/>
