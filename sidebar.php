<div class="half_sm" style="width: 32%; margin: 5% 0px 1% 5%;"> 
			<div class="addl_options">
				...
				<h4>Sizes</h4>
				<p> Toddler Size (6.5 inch): <span class="red">(+$0.10 each)</span><br>
					Youth Size (7 inch)<br>
					Medium Size (7.5 inch)<br>
					Adult Size (8 inch)<br>
					Extra Large (8.5 inch): <span class="red">(+$0.10 each)</span>
				</p>
				<h4>Wristband Widths</h4>
				<p> 1/4 Inch Wide: <span class="red">(Same price as 1/2 inch)</span><br>
					1/2 Inch Wide<br>
					1 Inch Wide<br>
					2 Inch Wide: <span class="red">(Call or Email for pricing)</span>
				</p>
