<?php
	...
	function generate_fig_segmented($colors)
	{
		...
		if (!file_exists("img/preview/figured/segmented/" . $name . ".png")) {
			...
			if ( count( $colors ) == 2 ) { // If 2 colors available
				...
				$img_1 = array(	'file'	 => 'img/belt/fig-segmented-color-r-23456.png',
								'colorR' => $r_1,
								'colorG' => $g_1,
								'colorB' => $b_1 );
				...
				$img_2 = array(	'file'	 => 'img/belt/fig-segmented-color-m-3.png',
								'colorR' => $r_2,
								'colorG' => $g_2,
								'colorB' => $b_2 );
				...
				// Declare image variables
				list( $r_2, $g_2, $b_2 ) = sscanf( $hex_2, "#%02x%02x%02x" );
				$img_2 = array(	'file'	 => 'img/belt/fig-segmented-color-l-4.png',
								'colorR' => $r_2,
								'colorG' => $g_2,
								'colorB' => $b_2 );
				$img_2_src = imagecreatefrompng( $img_2['file'] );
				...
				$img_3 = array(	'file'	 => 'img/belt/fig-segmented-color-r-4.png',
								'colorR' => $r_3,
								'colorG' => $g_3,
								'colorB' => $b_3 );
				...
				// Declare image variables
				list( $r_2, $g_2, $b_2 ) = sscanf( $hex_2, "#%02x%02x%02x" );
				$img_2 = array(	'file'	 => 'img/belt/fig-segmented-color-l-5.png',
								'colorR' => $r_2,
								'colorG' => $g_2,
								'colorB' => $b_2 );
				$img_2_src = imagecreatefrompng( $img_2['file'] );
				...
				// Declare image variables
				list( $r_3, $g_3, $b_3 ) = sscanf( $hex_3, "#%02x%02x%02x" );
				$img_3 = array(	'file'	 => 'img/belt/fig-segmented-color-r-5.png',
								'colorR' => $r_3,
								'colorG' => $g_3,
								'colorB' => $b_3 );
				$img_3_src = imagecreatefrompng( $img_3['file'] );
				...
				$img_4 = array(	'file'	 => 'img/belt/fig-segmented-color-m-5.png',
								'colorR' => $r_4,
								'colorG' => $g_4,
								'colorB' => $b_4 );
				...
				// Declare image variables
				list( $r_2, $g_2, $b_2 ) = sscanf( $hex_2, "#%02x%02x%02x" );
				$img_2 = array(	'file'	 => 'img/belt/fig-segmented-color-l-6.png',
								'colorR' => $r_2,
								'colorG' => $g_2,
								'colorB' => $b_2 );
				$img_2_src = imagecreatefrompng( $img_2['file'] );
				...
				// Declare image variables
				list( $r_3, $g_3, $b_3 ) = sscanf( $hex_3, "#%02x%02x%02x" );
				$img_3 = array(	'file'	 => 'img/belt/fig-segmented-color-r-6.png',
								'colorR' => $r_3,
								'colorG' => $g_3,
								'colorB' => $b_3 );
				$img_3_src = imagecreatefrompng( $img_3['file'] );
				...
				// Declare image variables
				list( $r_4, $g_4, $b_4 ) = sscanf( $hex_4, "#%02x%02x%02x" );
				$img_4 = array(	'file'	 => 'img/belt/fig-segmented-color-l-m-6.png',
								'colorR' => $r_4,
								'colorG' => $g_4,
								'colorB' => $b_4 );
				$img_4_src = imagecreatefrompng( $img_4['file'] );
				...
				$img_5 = array(	'file'	 => 'img/belt/fig-segmented-color-r-m-6.png',
								'colorR' => $r_5,
								'colorG' => $g_5,
								'colorB' => $b_5 );
			...
			if (!file_exists('img/preview/figured/segmented')) {
				mkdir('img/preview/figured/segmented', 0777, true); // If not, then create directory path
			}
			// Set colors as the image name
			$name = strtoupper(implode("-", $colors));
			// Make image
			imagepng( $img_0_dst, "img/preview/figured/segmented/" . $name . ".png" );
		...
		echo( "/gd/img/preview/figured/segmented/" . $name . ".png" );
