<?php
	...
	function generate_fig_swirl($colors)
	{
		...
		if (!file_exists("img/preview/figured/swirl/" . $name . ".png")) {
			...
			if ( isset( $colors[1] ) ) {
				...
				$img_1 = array(	'file'	 => 'img/belt/fig-swirl-color-1.png',
								'colorR' => $r_1,
								'colorG' => $g_1,
								'colorB' => $b_1 );
			...
			if ( isset( $colors[2] ) ) {
				...
				$img_2 = array(	'file'	 => 'img/belt/fig-swirl-color-2.png',
								'colorR' => $r_2,
								'colorG' => $g_2,
								'colorB' => $b_2 );
			...
			if ( isset( $colors[3] ) ) {
				...
				$img_3 = array(	'file'	 => 'img/belt/fig-swirl-color-3.png',
								'colorR' => $r_3,
								'colorG' => $g_3,
								'colorB' => $b_3 );
			...
			if (!file_exists('img/preview/figured/swirl')) {
				mkdir('img/preview/figured/swirl', 0777, true); // If not, then create directory path
			}
			// Set colors as the image name
			$name = strtoupper(implode("-", $colors));
			// Make image
			imagepng( $img_0_dst, "img/preview/figured/swirl/" . $name . ".png" );
		...
		echo( "/gd/img/preview/figured/swirl/" . $name . ".png" );
